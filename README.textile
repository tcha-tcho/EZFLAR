...
package {
	...
	public class Main extends MovieClip {
		...
		public function Main() {
			p{color:gray;}. _symbols will take all your markers and models and work with this in couples... ezflar can handle a lot of formats for you, so enjoy  :)   you can also create names for your models to group or to access this models for your names later. Look how to do that in "myoptionalname". The markers will be access by your numbers, so remember that: begin with 0
