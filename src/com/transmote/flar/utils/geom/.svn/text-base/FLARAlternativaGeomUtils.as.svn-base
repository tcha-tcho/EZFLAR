...
package com.transmote.flar.utils.geom {
	...
	public class FLARAlternativaGeomUtils {
		 ...
		 * @param	fm			FLARToolkit NyARDoubleMatrix34 to convert.
		 ...
		 */
		public static function convertFLARMatrixToAlternativaMatrix (fm:NyARDoubleMatrix34, bMirror:Boolean=true) :Matrix3D {
			if (bMirror) {
